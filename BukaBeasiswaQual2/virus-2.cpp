...
public:
    ...
    void Update() //Menampilkan output
    {
		...
		{
			if(name != "M4G3R") //M4G3R tidak terkena LebayEffect
			{
				...
				else if(age%3 == 0) //Selain virus 4L4Y, B41K, M4G3R, LBHB41K, dan usia dibawah 200, tingkat keganasan bertambah satu setiap usia kelipatan tiga.
		        {
		            malignancy++;
		        }
			}
